...
Deselvolvimento de uma plataforma proprietário visando redução de custo e performace para fluxos de loja. 
## Objetivos

- **Escopo princial**: Proporcionar para lojas o fluxo de invertário e recebimento de modo seguro e confiável.
- **Necessidades**: Integrated a theming system that allows easy switching and customization of color palettes, typography, and layout styles using CSS variables and Figma tokens.
